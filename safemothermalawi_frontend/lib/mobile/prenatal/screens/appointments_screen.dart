...
class _Appointment {
  ...
  final String doctor;
  final DateTime date;
  final String status; // 'tomorrow' | 'weeks' | 'confirmed' | 'pending'
...
class _AppointmentsScreenState extends State<AppointmentsScreen> {
  ...
  final List<_Appointment> _appointments = [
    ...
    _Appointment(
      ...
      doctor: 'Dr. Kondwani Phiri',
      date: DateTime.now().add(const Duration(days: 14)),
      status: 'weeks',
    ),
    _Appointment(
      title: 'Blood work & screening',
      time: '8:00 AM',
                ...
                if (titleCtrl.text.isNotEmpty && picked != null) {
                  setState(() {
                    _appointments.add(_Appointment(
                      ...
                      doctor: doctorCtrl.text.isEmpty ? 'TBD' : doctorCtrl.text,
                      date: picked!,
                      status: 'pending',
                    ));
