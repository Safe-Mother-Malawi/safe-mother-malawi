...
/// Neonatal health check start screen - shows overview and options to start or view history
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Monitor your baby\'s health with our quick assessment. Answer questions about your baby\'s condition to get health insights.',
                          style: TextStyle(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => NeonatalHealthScreen(
                              data: widget.data,
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            'Take your first health check to start monitoring your baby\'s health.',
                      ...
                      children: [
                        const Row(
                          children: [
                            ...
                            SizedBox(width: 8),
                            Text(
                              'Baby Danger Signs — Seek Help Immediately',
                              style: TextStyle(
                                fontSize: 13,
                                fontWeight: FontWeight.bold,
                        ...
                        const SizedBox(height: 8),
                        ...NeonatalData.dangerSigns.take(4).map((sign) => Padding(
