...
class _CallScreenState extends State<CallScreen> {
  ...
  Future<void> _loadSupportedLanguages() async {
    try {
      // Simplified - just use English for now since IVR was removed
      setState(() {
        _supportedLanguages = [
          {
            'code': 'en',
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('Call functionality has been removed. Please dial 700 directly for emergency support.'),
