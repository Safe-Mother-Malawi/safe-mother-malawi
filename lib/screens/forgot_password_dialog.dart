...
/// Web forgot password dialog with 3-step security question flow
...
class _ForgotPasswordDialogState extends State<ForgotPasswordDialog> {
  ...
  Future<void> _lookupAccount() async {
    ...
    try {
      ...
      if (question == null || question.isEmpty) {
        setState(() {
          _loading = false;
          _error = 'No account found for that email or phone number.';
        });
        return;
      }
      ...
      setState(() {
        _loading = false;
        _error = e.statusCode == 404 || e.statusCode == 400
  ...
  Future<void> _resetPassword() async {
    ...
    try {
      ...
      setState(() {
        _loading = false;
        if (e.statusCode == 400 && e.message.toLowerCase().contains('incorrect')) {
          _error = 'Incorrect security answer. Please try again.';
          _step = 1; // Go back to answer step
        } else {
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: _inputDecoration('Email or phone number', Icons.person_outline),
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            onPressed: _loading ? null : _lookupAccount,
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Icon(Icons.help_outline, color: _navy, size: 20),
        ...
        TextFormField(
          ...
          onChanged: (_) => setState(() => _error = null),
          decoration: _inputDecoration('Your answer', Icons.question_answer_outlined),
        ),
        if (_error != null) _buildError(_error!),
        const SizedBox(height: 24),
        Row(
