...
class PrenatalHealthCheckScreen extends StatefulWidget {
  const PrenatalHealthCheckScreen({super.key});

  @override
  State<PrenatalHealthCheckScreen> createState() => _PrenatalHealthCheckScreenState();
}

class _PrenatalHealthCheckScreenState extends State<PrenatalHealthCheckScreen> {
      ...
      if (mounted) {
        setState(() {
          ...
          if (questions.isEmpty) {
            _error = 'No questions available for your stage';
          }
        });
      }
    } catch (e) {
    ...
    try {
      ...
      if (mounted) {
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(
            builder: (_) => PrenatalHealthCheckResultScreen(result: result),
          ),
        );
      }
    } catch (e) {
                    ...
                    if (currentQuestion['severityTag'] != null) ...[
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: _getSeverityColor(currentQuestion['severityTag']).withValues(alpha: 0.1),
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      disabledBackgroundColor: const Color(0xFFBBBEF0),
                    ),
                    child: _submitting
                        ? const SizedBox(
                            height: 20,
